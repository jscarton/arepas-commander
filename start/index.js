...
try {
  ...
  if (shell.exec(_shell_command).code !== 0) {
    ...
    console.log(chalk.cyan('ERROR:')+ 'trying to start ADE for '+platform.toUpperCase()+", please ensure you have initialized this ADE");
}

console.log(chalk.green('SUCCESS:')+ 'ADE for '+platform.toUpperCase()+' has been initialized at '+cwd+'/arepas4'+platform);